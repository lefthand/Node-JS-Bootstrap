...
exports.add_routes = function (app) {
  ...
  app.get('/post/create', loadUser, loadCategories, function(req, res){
  ...
  app.get('/post/:id/edit', loadUser, loadCategories, loadPost, function(req, res, next){
  ...
  app.get('/post/:id/remove', loadUser, loadPost, function(req, res, next){
  ...
  app.get('/post/:id', loadUser, loadPost, function(req, res){
  ...
  app.post('/post/submit/:id?', loadUser, loadPost, function(req, res){
    data = {};
  ...
  app.get('/posts', loadUser, loadCategories, function(req, res){
    find = {};
